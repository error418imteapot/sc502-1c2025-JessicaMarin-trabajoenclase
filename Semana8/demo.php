...
//esta es otra forma que podemos declarar un arreglo con []
$productos = [
...
// a nivel global vamos a declarar el arreglo carrito 
$carrito = [];
 
function buscarProductoPorId($id)
{
    //si necesito acceder a esta variable dentro de la funcion se llama con el global
    global $productos;
